...
// enhancement): sin este script, o con JS deshabilitado, la página sigue
// siendo un listado íntegro y navegable.
(function () {
  var grid = document.getElementById("grid");
  if (!grid) return; // no estamos en el index
  ...
  function apply() {
    ...
    resultCount.textContent = visible + (visible === 1 ? " API encontrada" : " APIs encontradas");
